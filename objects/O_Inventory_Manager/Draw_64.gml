...
if(global.showInventory == true){	/// @DnDAction : YoYo Games.Drawing.Draw_Sprite_Transformed
	...
	if(O_Player_Coin_Manager.coin_amount >= 100){	/// @DnDAction : YoYo Games.Drawing.Draw_Value_Transformed
		/// @DnDVersion : 1
		/// @DnDHash : 1788CF88
		/// @DnDParent : 1306C3EB
		/// @DnDArgument : "x" "600 + 16 + 6 mod row_length * ((720-32)/3) + 625"
		/// @DnDArgument : "y" "560"
		/// @DnDArgument : "xscale" "2"
		/// @DnDArgument : "yscale" "2"
		/// @DnDArgument : "caption" """"
		/// @DnDArgument : "text" "O_Player_Coin_Manager.coin_amount"
		draw_text_transformed(600 + 16 + 6 mod row_length * ((720-32)/3) + 625, 560, string("") + string(O_Player_Coin_Manager.coin_amount), 2, 2, 0);}
	...
	/// @DnDParent : 29C0140D
		...
		/// @DnDHash : 365A4853
		/// @DnDParent : 4C4CBE7C
		/// @DnDArgument : "x" "600 + 16 + 6 mod row_length * ((720-32)/3) + 630"
		/// @DnDArgument : "y" "550"
		/// @DnDArgument : "xscale" "3"
		/// @DnDArgument : "yscale" "3"
		/// @DnDArgument : "caption" """"
		/// @DnDArgument : "text" "O_Player_Coin_Manager.coin_amount"
		draw_text_transformed(600 + 16 + 6 mod row_length * ((720-32)/3) + 630, 550, string("") + string(O_Player_Coin_Manager.coin_amount), 3, 3, 0);}}