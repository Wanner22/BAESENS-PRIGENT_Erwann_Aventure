...
if(global.showInventory == true){	/// @DnDAction : YoYo Games.Drawing.Draw_Sprite_Transformed
	...
	draw_sprite_ext(S_Inventory, 0, 600, 150, (global.camera_width - 600) / 32 - 600/32, ((global.camera_width - 600) / 32 - 600/32) *2/3 + 8/64, 0, $FFFFFF & $ffffff, 1);
	...
	for(i = 0; i < n_slots; i += 1) {	/// @DnDAction : YoYo Games.Common.Variable
		...
		draw_sprite_ext(S_Inventory_Slot, 0, xx, yy, 688/32/3, 688/32/3, 0, $FFFFFF & $ffffff, 1);}}